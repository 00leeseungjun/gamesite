...
export const posts = [
    ...
    },
    {
        id: 101,
        category: '질문',
        title: '엘든링 보스 공략 어떻게 하세요?',
        user_id: '닉네임101',
        date: '2025.7.22',
        views: 154,
        likes: 21,
        content: '말레니아에서 자꾸 죽는데 어떤 무기나 전략이 좋은가요?',
        scrapped: false
    },
    {
        id: 102,
        ...
        views: 97,
        likes: 14,
        content: '혼자서 하다 보니 지루해지네요. 멀티 하면 더 재밌을까요?',
        scrapped: false
    },
    {
        id: 103,
        category: '질문',
        title: '디아4 야만용사 스킬 트리 질문',
        user_id: '닉네임103',
        date: '2025.7.20',
        views: 122,
        likes: 17,
        content: '소용돌이랑 광분 중에 어떤 스킬 트리가 더 효율적일까요?',
        scrapped: false
    }
                ...
                >
                    {visiblePosts.map((p) => (
                        <div
                            key={p.id}
                            className="post-row"
                            onClick={() => navigate(`/community/post/${p.id}`)} // 🔥 상세 페이지로 이동
